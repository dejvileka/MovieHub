...
fun getWatchProviders(): Map<String, WatchProvider> {
    return mapOf(
        ...
        "NetMovies" to WatchProvider("NetMovies", "https://www.netflix.com"),
        ...
        "MGM Amazon ChannelPlus" to WatchProvider("MGM Amazon Channel", "https://www.mgm.com"),
        ...
        "BoxOffice" to WatchProvider("BoxOffice", "https://www.dstv.com/en-za/boxoffice"),
        ...
        "Filmin Plus" to WatchProvider("Filmin Plus", "https://www.filmin.es/"),
        "Filmin Latino" to WatchProvider("Filmin Latino", "https://www.filminlatino.mx/"),
        "Microsoft Store" to WatchProvider(
            "Microsoft Store",
        ...
        "Hoopla" to WatchProvider(
            providerName = "Hoopla",
            providerUrl = "https://www.hoopladigital.com/"
        ),
        "Eros Now" to WatchProvider(
            providerName = "Eros Now",
            providerUrl = "https://erosnow.com/"
        ),
        "ARD Mediathek" to WatchProvider(
            providerName = "ARD Mediathek",
            providerUrl = "https://www.ardmediathek.de/ard/"
        ),
        "Jio Cinema" to WatchProvider(
            providerName = "Jio Cinema",
            providerUrl = "https://www.jiocinema.com/"
        ),
        "Rai Play" to WatchProvider(
            providerName = "Rai Play",
            providerUrl = "https://www.raiplay.it/"
        ),
        "BFI Player" to WatchProvider(
            providerName = "BFI Player",
            providerUrl = "https://player.bfi.org.uk/"
        ),
        "Telecine Play" to WatchProvider(
            providerName = "Telecine Play",
            providerUrl = "https://www.telecineplay.com.br/"
        ),
        ...
        "YouTube Free" to WatchProvider(
            providerName = "YouTube Free",
            providerUrl = "https://www.youtube.com/"
        ),
        "France TV" to WatchProvider(
            providerName = "France TV",
            providerUrl = "https://www.france.tv/"
        ),
        "Sony Liv" to WatchProvider(
            providerName = "Sony Liv",
            providerUrl = "https://www.sonyliv.com/"
        ),
        "Universcine" to WatchProvider(
            providerName = "Universcine",
            providerUrl = "https://www.universcine.be/"
        ),
        "Popcornflix" to WatchProvider(
            providerName = "Popcornflix",
            providerUrl = "https://www.popcornflix.com/"
        ),
        "Meo" to WatchProvider(providerName = "Meo", providerUrl = "https://meo.pt/"),
        "Comedy Central" to WatchProvider(
            providerName = "Comedy Central",
            providerUrl = "https://www.cc.com/"
        ),
        "VOD Poland" to WatchProvider(providerName = "VOD Poland", providerUrl = "https://vod.pl/"),
        "7plus" to WatchProvider(providerName = "7plus", providerUrl = "https://7plus.com.au/"),
        "Boomerang" to WatchProvider(
            providerName = "Boomerang",
            providerUrl = "https://www.boomerang.com/"
        ),
        "Horizon" to WatchProvider(providerName = "Horizon", providerUrl = "https://horizon.tv/"),
        "Urban Movie Channel" to WatchProvider(
            providerName = "Urban Movie Channel",
            providerUrl = "https://www.umc.tv/"
        ),
        "Yupp TV" to WatchProvider(
            providerName = "Yupp TV",
            providerUrl = "https://www.yupptv.com/"
        ),
        "fuboTV" to WatchProvider(providerName = "fuboTV", providerUrl = "https://www.fubo.tv/"),
        "Criterion Channel" to WatchProvider(
            providerName = "Criterion Channel",
            providerUrl = "https://www.criterionchannel.com/"
        ),
        "Magnolia Selects" to WatchProvider(
            providerName = "Magnolia Selects",
            providerUrl = "https://www.magnoliaselects.com/"
        ),
        "WWE Network" to WatchProvider(
            providerName = "WWE Network",
            providerUrl = "https://watch.wwe.com/"
        ),
        "Noggin Amazon Channel" to WatchProvider(
            providerName = "Noggin Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "History Vault" to WatchProvider(
            providerName = "History Vault",
            providerUrl = "https://www.historyvault.com/"
        ),
        "Funimation Now" to WatchProvider(
            providerName = "Funimation Now",
            providerUrl = "https://www.funimation.com/"
        ),
        "Neon TV" to WatchProvider(
            providerName = "Neon TV",
            providerUrl = "https://www.neontv.co.nz/"
        ),
        "Boomerang Amazon Channel" to WatchProvider(
            providerName = "Boomerang Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "Cinemax Amazon Channel" to WatchProvider(
            providerName = "Cinemax Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "Hallmark Movies Now Amazon Channel" to WatchProvider(
            providerName = "Hallmark Movies Now Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "MZ Choice Amazon Channel" to WatchProvider(
            providerName = "MZ Choice Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "PBS Kids Amazon Channel" to WatchProvider(
            providerName = "PBS Kids Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "PBS Masterpiece Amazon Channel" to WatchProvider(
            providerName = "PBS Masterpiece Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "Viewster Amazon Channel" to WatchProvider(
            providerName = "Viewster Amazon Channel",
            providerUrl = "https://www.amazon.com/gp/video/storefront/?contentType=merch&ie=UTF8&node=2858778011"
        ), // Needs specific Amazon link
        "Ziggo TV" to WatchProvider(
            providerName = "Ziggo TV",
            providerUrl = "https://www.ziggo.nl/televisie"
        ),
        "RTL+" to WatchProvider(providerName = "RTL+", providerUrl = "https://www.rtlplus.com/"),
        ...
        "Crave Starz" to WatchProvider(
            providerName = "Crave Starz",
            providerUrl = "https://www.crave.ca/"
        ),
        "Globoplay" to WatchProvider(
            providerName = "Globoplay",
            providerUrl = "https://globoplay.globo.com/"
        ),
        "Cineplex" to WatchProvider("Cineplex", "https://www.cineplex.com/"),
        "Sundance Now" to WatchProvider("Sundance Now", "https://www.sundancenow.com/"),
        "iciTouTV" to WatchProvider("iciTouTV", "https://ici.tou.tv/"),
        ...
        "BritBox Amazon Channel" to WatchProvider(
            "BritBox Amazon Channel",
            "https://www.amazon.com/Prime-Video/b?node=2858778011"
        ),
        "Fandor Amazon Channel" to WatchProvider(
            "Fandor Amazon Channel",
            "https://www.amazon.com/Prime-Video/b?node=2858778011"
        ),
        "MUBI Amazon Channel" to WatchProvider(
            "MUBI Amazon Channel",
            "https://www.amazon.com/Prime-Video/b?node=2858778011"
        ),
        "Screambox Amazon Channel" to WatchProvider(
            "Screambox Amazon Channel",
            "https://www.amazon.com/Prime-Video/b?node=2858778011"
        ),
        "Showtime Amazon Channel" to WatchProvider(
            "Showtime Amazon Channel",
            "https://www.amazon.com/Prime-Video/b?node=2858778011"
        ),
        "Shudder Amazon Channel" to WatchProvider(
            "Shudder Amazon Channel",
            "https://www.amazon.com/Prime-Video/b?node=2858778011"
        ),
        "Sundance Now Amazon Channel" to WatchProvider(
        ...
        "Spectrum On Demand" to WatchProvider(
            providerName = "Spectrum On Demand",
            providerUrl = "https://www.spectrum.net/support/tv/spectrum-tv-app/"
        ),
        ...
        "CINE" to WatchProvider(providerName = "CINE", providerUrl = "https://www.cine.ar/"),
        "SVT" to WatchProvider(providerName = "SVT", providerUrl = "https://www.svtplay.se/"),
        "Cineasterna" to WatchProvider(
            providerName = "Cineasterna",
            providerUrl = "https://www.cineasterna.se/"
        ),
        "Tele2 Play" to WatchProvider(
            providerName = "Tele2 Play",
            providerUrl = "https://www.tele2.se/tv"
        ),
        "Oldflix" to WatchProvider(
            providerName = "Oldflix",
            providerUrl = "https://oldflix.com.br/"
        ),
        "Tata Play" to WatchProvider(
            providerName = "Tata Play",
            providerUrl = "https://www.tataplay.com/"
        ),
        ...
        "DisneyNOW" to WatchProvider(
            providerName = "DisneyNOW",
            providerUrl = "https://watch.disneynow.com/"
        ),
        "Discovery+" to WatchProvider(
